...
def get_ai_response(chat_history):
    ...
    try:
        ...
        # TEMPORARY: showing the real error so we can debug what's actually
        # wrong. Once she's working, tell Claude to switch this back to the
        # friendly nap message for real users.
        return f"💤 DEBUG — real error was: {type(e).__name__}: {e}"
